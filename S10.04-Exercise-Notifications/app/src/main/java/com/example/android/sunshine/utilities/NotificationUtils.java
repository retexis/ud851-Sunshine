...
//  TODO DONE (1) Create a constant int value to identify the notification
    private static final int WEATHER_NOTIFICATION_ID = 5005;
...
//          TODO DONE (2) Use NotificationCompat.Builder to begin building the notification

//          TODO DONE (3) Create an Intent with the proper URI to start the DetailActivity

//          TODO DONE (4) Use TaskStackBuilder to create the proper PendingIntent

//          TODO DONE (5) Set the content Intent of the NotificationBuilder

//          TODO DONE (6) Get a reference to the NotificationManager

//          TODO DONE (7) Notify the user with the ID WEATHER_NOTIFICATION_ID

//          TODO DONE (8) Save the time at which the notification occurred using SunshinePreferences
